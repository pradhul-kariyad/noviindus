  ...
  Widget build(BuildContext context) {
    return Consumer<PatientListDataProvider>(
      builder: (BuildContext context, patientDataProvider, Widget? child) {
        ...
        if (patientDataProvider.filteredPatientList.patient == null ||
            patientDataProvider.filteredPatientList.patient!.isEmpty) {
          return Center(
            child: Text(
              "No users found",
              style: TextStyle(
        ...
        return SizedBox(
          ...
          child: ListView.builder(
            itemCount: patientDataProvider.filteredPatientList.patient!.length,
            scrollDirection: Axis.vertical,
            padding: EdgeInsets.symmetric(vertical: 10.h),
            itemBuilder: (BuildContext context, int index) {
              final patient =
                  patientDataProvider.filteredPatientList.patient![index];
              return Center(
                child: Container(
                  margin:
